...
To update the database use this command from the Web project folder (replace `FanapTest` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FanapTest.Infrastructure/FanapTest.Infrastructure.csproj -s FanapTest.Web.csproj
```
